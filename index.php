    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore Our Range of Candles</h2>
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <p class="text-center" style="color: red;">See All Products</p>

        </div>

       
        <script type="text/javascript">
    document.getElementById("See All Products").onclick = function () {
        location.href = " https://my.linkedin.com/company/therapy-lab-savor-the-scent ";
    };
</script>
